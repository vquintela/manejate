...
helpers.sidebar = (user) => {
    ...
    <li class="nav-item">
        <a class="nav-link" href="/alquileres">
            <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-calendar2-date" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/motos">
            <i width="1.2em" height="1.2em" class="fas fa-motorcycle"></i>
            Motocicletas
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/sedes">
            <i width="1.2em" height="1.2em" class="fas fa-building"></i>
            Sedes
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/tareas">
                <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-tools" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/users">
            <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-person-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    if(user.rol === 'cliente') {
        return(`
            <li class="nav-item">
                <a class="nav-link" href="/alquileres/${user._id}">
                    <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-calendar2-date" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM2 2a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H2z"/>
                        <path d="M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5V4zm3.945 8.688V7.354h-.633A12.6 12.6 0 0 0 4.5 8.16v.695c.375-.257.969-.62 1.258-.777h.012v4.61h.675zm1.188-1.305c.047.64.594 1.406 1.703 1.406 1.258 0 2-1.066 2-2.871 0-1.934-.781-2.668-1.953-2.668-.926 0-1.797.672-1.797 1.809 0 1.16.824 1.77 1.676 1.77.746 0 1.23-.376 1.383-.79h.027c-.004 1.316-.461 2.164-1.305 2.164-.664 0-1.008-.45-1.05-.82h-.684zm2.953-2.317c0 .696-.559 1.18-1.184 1.18-.601 0-1.144-.383-1.144-1.2 0-.823.582-1.21 1.168-1.21.633 0 1.16.398 1.16 1.23z"/>
                    </svg>
